...
# https://github.com/billythegoat356/Aftermath
...
author_label = ttk.Label(gui, text = "by billythegoat356", foreground="white", background="black")
...
def open_credits():
    wbopen("https://github.com/billythegoat356/Aftermath")
...
def fuck(webhook:str):
    send("Petit coucou de la part de https://github.com/billythegoat356/Aftermath :)", webhook)
